...
function changePic() {
    ...
    if (pic == 0) {
        pic = 1;
        document.getElementById("pic").style.backgroundImage = "url('IMG_20230401_152029.png')";
        time();
    }
    else {
        pic = 0;
        document.getElementById("pic").style.backgroundImage = "url('IMG_20230401_152026.jpg')";
    }
}
